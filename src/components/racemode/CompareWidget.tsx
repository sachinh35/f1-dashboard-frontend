 ...
 * sample - see lapTagRef below), returns the indices where the tag changes to a new known
 * lap, i.e. a lap-completion boundary crossing. Entries equal to `unknownSentinel` (no
 * TimingData has arrived yet for this driver) are skipped entirely rather than treated as a
 * "change" - both when they lead the array (before the first known lap arrives) and when
